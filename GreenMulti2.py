...
#		try:
			...
			params = {'url': 'http%3A%2F%2Fhan.kbuwel.or.kr', 'mb_id': kbuid, 'mb_password': kbupw}
			self.menu.Post('/bbs/login_check.php', params)

			if self.menu.response.getheader('Location') and 'han.kbuwel.or.kr' in self.menu.response.getheader('Location'):
